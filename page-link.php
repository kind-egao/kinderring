...
<ul class="link-list">
  ...
  $hospital_links = [
    ...
    ['title' => '帝京大学医学部付属病院', 'url' => 'http://www.teikyo-hospital.jp/', 'image' => 'teikyo_hospital.png'],
    ['title' => '日本大学医学部付属板橋病院', 'url' => 'http://www.med.nihon-u.ac.jp/hospital/itabashi/', 'image' => 'nichidai_itabashi.png'],
    ['title' => '東京都保健医療公社豊島病院', 'url' => 'http://www.toshima-hp.jp/', 'image' => 'toshima_hp.png'],
    ['title' => '東京北医療センター', 'url' => 'https://www.tokyokita-jadecom.jp/', 'image' => 'tokyo_kita.png'],
    ['title' => '板橋区医師会病院', 'url' => 'http://www.itabashi-med.jp/', 'image' => 'itabashi_hospital.png'],
    ['title' => '国立成育医療研究センター', 'url' => 'http://www.ncchd.go.jp/index.html', 'image' => 'ncchd.png'],
  ];
